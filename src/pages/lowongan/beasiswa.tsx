import { VacancyLayout, VacancyProps } from "components/layouts";

const data: VacancyProps[] = [
  {
    id: 0,
...
export default function LowonganBeasiswa() {
  return <VacancyLayout title="Lowongan Beasiswa" data={data} />;
}
